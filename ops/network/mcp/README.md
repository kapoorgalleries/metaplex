...
| `trimurti_verify_hosts` | yes | `verify.sh`: ping, key login and CLI versions (claude, codex, gemini, hf, node) per host; `all_green` (computers only, node 20+) and a problems list |
