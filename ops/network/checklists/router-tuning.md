...
| 6 GHz (Wi-Fi 6E/7): on if the router and the laptops support it | Empty band, no DFS, wide channels | Same SSID and password as 5 GHz, WPA3, a PSC channel (5, 21, 37, 53, 69, 85, 101, 117, 133, 149, 165, 181, 197, 213), 160 MHz. Wi-Fi 7 MLO on only if every client behaves | 6E clients show a 6 GHz link | Off |
